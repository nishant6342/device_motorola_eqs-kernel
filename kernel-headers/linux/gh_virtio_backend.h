...
#define GH_IOEVENTFD _IOW(VIRTIO_BE_IOC_MAGIC, 2, struct virtio_eventfd)
#define GH_IRQFD _IOW(VIRTIO_BE_IOC_MAGIC, 3, struct virtio_irqfd)
#define GH_WAIT_FOR_EVENT _IOWR(VIRTIO_BE_IOC_MAGIC, 4, struct virtio_event)
#define GH_SET_DEVICE_FEATURES _IOW(VIRTIO_BE_IOC_MAGIC, 5, struct virtio_dev_features)
#define GH_SET_QUEUE_NUM_MAX _IOW(VIRTIO_BE_IOC_MAGIC, 6, struct virtio_queue_max)
#define GH_SET_DEVICE_CONFIG_DATA _IOW(VIRTIO_BE_IOC_MAGIC, 7, struct virtio_config_data)
#define GH_GET_DRIVER_CONFIG_DATA _IOWR(VIRTIO_BE_IOC_MAGIC, 8, struct virtio_config_data)
#define GH_GET_QUEUE_INFO _IOWR(VIRTIO_BE_IOC_MAGIC, 9, struct virtio_queue_info)
#define GH_GET_DRIVER_FEATURES _IOWR(VIRTIO_BE_IOC_MAGIC, 10, struct virtio_driver_features)
